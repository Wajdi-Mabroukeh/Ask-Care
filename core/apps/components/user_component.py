...
class UserComponent:
    ...
    def create_new_patient(email: str, username: str, mobile: str, password: any,
        ...
        try:
            ...
            new_patient.otp = otp
            signup_firebase(id=new_patient.id, email=email, password=password, name=username,
                            avatar='https://d2pas86kykpvmq.cloudfront.net/images/humans-3.0/ava-1.png', type='patient')
            new_patient.save()
    ...
    def create_new_specialist(email: str, username: str, mobile: str, password: any):
        try:
            ...
            new_patient.save()
            signup_firebase(id=new_patient.id, email=email, password=password, name=username,
                            avatar='https://d2pas86kykpvmq.cloudfront.net/images/humans-3.0/ava-1.png', type='Special')
